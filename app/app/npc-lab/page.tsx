    ...
    <div>
      <div className={"h-16 border-b flex items-center px-5 gap-5 border-gray-200 dark:border-gray-800"}>
        ...
        <div className={"flex items-center"}>
          <Link href={"/app/npc-lab"} className={"h-7 px-3 text-[14px] flex items-center font-medium rounded-full bg-foreground text-background"}>
            My NPC
          </Link>
      ...
      <div className={"flex flex-col gap-3 pt-5 pb-4"}>
        ...
        <div className={"md:flex flex items-center justify-between gap-6 px-5 pt-0 pb-5 mt-0 border-b border-gray-200 dark:border-gray-800"}>
