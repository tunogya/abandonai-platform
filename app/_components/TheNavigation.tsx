...
const TheNavigation = () => {
  ...
  const menu = [
    {
      name: "首页",
      icon: <svg aria-label="首页" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24" role="img"
      ...
      activeIcon: <svg aria-label="首页" className="x1lliihq x1n2onr6 x5n08af" fill="currentColor" height="24"
                       role="img"
                       viewBox="0 0 24 24" width="24"><title>首页</title>
        <path
    ...
    //       fill="none" stroke="currentColor" stroke-miterlimit="10" strokeWidth="1.739"></path>
    //     <path
